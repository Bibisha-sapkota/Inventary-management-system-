...
import { Download, Upload, Plus, ImageIcon, Pencil, Trash2, Search } from "lucide-react";
...
const ProductsTab = ({
  ...
  return (
    <div className={`${cardClass} rounded-2xl shadow-sm p-8 border-2`}>
        ...
        <div className="flex flex-1 max-w-2xl items-center gap-4 w-full">
          <div className="relative flex-1 group">
            ...
            <input
              ...
              className={`w-full pl-12 pr-4 py-3.5 rounded-2xl border-2 text-sm font-bold transition-all outline-none ${
                darkMode 
      ...
      <div
        className={`border-2 rounded-2xl overflow-hidden ${darkMode ? "border-gray-700" : "border-gray-200"
          }`}
      >
