  ...
  return (
    <div className={`${cardClass} rounded-2xl shadow-sm overflow-hidden`}>
      <div className="p-8 pb-0">
        ...
        <div
          className={`border rounded-lg overflow-x-auto mb-6 ${darkMode ? "border-gray-700" : "border-gray-200"
            }`}
        >
            ...
            <tbody>
              {paginatedOrders.length === 0 ? (
                ...
                paginatedOrders.map((o, i) => (
                  ...
                  >
                    <td className="py-4 px-4 border text-sm">{((currentPage - 1) * PAGE_SIZE) + i + 1}</td>
